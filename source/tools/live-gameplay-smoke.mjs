...
const source=path.dirname(path.dirname(fileURLToPath(import.meta.url))),home=path.join(source,'build','live-gameplay-'+Date.now()),root=await initializeData(home,'0.8.0');
